...
ohos_rootfs_append_entries() {
    ...
    _out+=("$ROOT/build/user/coreutils.elf::/bin/coreutils")
    _out+=("$ROOT/build/user/coreutils.elf::/bin/cp")
    _out+=("$ROOT/build/user/coreutils.elf::/bin/mv")
    _out+=("$ROOT/build/user/coreutils.elf::/bin/rm")
    _out+=("$ROOT/build/user/coreutils.elf::/bin/ln")
    _out+=("$ROOT/build/user/coreutils.elf::/bin/chmod")
    _out+=("$ROOT/build/user/coreutils.elf::/bin/touch")
    _out+=("$ROOT/build/user/coreutils.elf::/bin/head")
    _out+=("$ROOT/build/user/coreutils.elf::/bin/tail")
    _out+=("$ROOT/build/user/coreutils.elf::/bin/wc")
    _out+=("$ROOT/build/user/coreutils.elf::/bin/sort")
    _out+=("$ROOT/build/user/coreutils.elf::/bin/uniq")
    _out+=("$ROOT/build/user/coreutils.elf::/bin/cut")
    _out+=("$ROOT/build/user/coreutils.elf::/bin/tr")
    _out+=("$ROOT/build/user/coreutils.elf::/bin/tee")
    _out+=("$ROOT/build/user/coreutils.elf::/bin/basename")
    _out+=("$ROOT/build/user/coreutils.elf::/bin/dirname")
    _out+=("$ROOT/build/user/coreutils.elf::/bin/dd")
    _out+=("$ROOT/build/user/coreutils.elf::/bin/cmp")
    _out+=("$ROOT/build/user/coreutils.elf::/bin/seq")
    _out+=("$ROOT/build/user/coreutils.elf::/bin/true")
    _out+=("$ROOT/build/user/coreutils.elf::/bin/false")
    _out+=("$ROOT/build/user/coreutils.elf::/bin/yes")
    _out+=("$ROOT/build/user/coreutils.elf::/bin/whoami")
    _out+=("$ROOT/build/user/coreutils.elf::/bin/hostname")
    _out+=("$ROOT/build/user/coreutils.elf::/bin/test")
    _out+=("$ROOT/build/user/coreutils.elf::/bin/[")
    _out+=("$ROOT/build/user/coreutils.elf::/bin/readlink")
    _out+=("$ROOT/build/user/coreutils.elf::/bin/link")
